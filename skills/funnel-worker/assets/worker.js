/**
 * Funnel Worker scaffold.
 *
 * One job: the landing page for the core offer, plus lead
 * capture. Checkout and everything after it belongs to the cart platform, including
...
async function handleLead(request, env, ctx) {
  ...
  // Client hands off to the cart platform after this resolves; see src/pages/landing.html.
  ...
  try {
    ...
    return json({
      ...
      notes: {
        ...
        purchases: 'Always 0 until a the cart platform webhook writes to the orders table. Nothing writes it yet.',
      },
    });
  } catch (err) {
